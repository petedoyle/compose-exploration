 ...
 *
 * @param title The title for the video. If left blank, this will be filled in according to data on a host site. 
 * @param description The description for the video. If left blank, this will be filled in according to data on a host site. 
 ...
 * @param type The video type (a short name of a host site). 
 * @param videoId The ID of the video on a host site.
 * @param id The unique numeric ID of the product video; increments sequentially. 
 * @param productId The unique numeric identifier for the product with which the image is associated. 
 * @param length Length of the video. This will be filled in according to data on a host site. 
 */
@JsonClass(generateAdapter = true)
data class ProductVideoFull (
    ...
    @Json(name = "type")
    val type: ProductVideoFull.Type? = null,
