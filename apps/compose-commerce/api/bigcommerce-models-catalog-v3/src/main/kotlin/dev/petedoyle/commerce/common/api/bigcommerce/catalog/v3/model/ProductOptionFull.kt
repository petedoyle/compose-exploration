...
data class ProductOptionFull (
    ...
    @Json(name = "type")
    val type: ProductOptionFull.Type? = null,

    @Json(name = "config")
    val config: kotlin.collections.List<ProductOptionConfigFull>? = null,
    ...
    val optionValues: kotlin.collections.List<ProductOptionOptionValueFull>? = null,
