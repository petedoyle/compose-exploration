 ...
 *
 * @param id The unique numeric ID of the category; increments sequentially. 
 * @param parentId The unique numeric ID of the category's parent. This field controls where the category sits in the tree of categories that organize the catalog. 
 * @param name The name displayed for the category. Name is unique with respect to the category's siblings. 
 ...
 * @param url The custom URL for the category on the storefront. 
 * @param children The list of children of the category. 
 */
@JsonClass(generateAdapter = true)
data class CategoriesTreeNodeFull (
    ...
    @Json(name = "children")
    val children: kotlin.collections.List<CategoriesTreeNodeFull>? = null
