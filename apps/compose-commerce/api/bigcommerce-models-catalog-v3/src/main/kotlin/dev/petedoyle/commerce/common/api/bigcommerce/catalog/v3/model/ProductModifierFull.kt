 ...
 * @param id The unique numeric ID of the modifier; increments sequentially. 
 * @param productId The unique numeric ID of the product to which the option belongs. 
 * @param name The unique option name. Auto-generated from the display name, a timestamp, and the product ID. 
 * @param optionValues 
 */
@JsonClass(generateAdapter = true)
data class ProductModifierFull (
    ...
    @Json(name = "type")
    val type: ProductModifierFull.Type,
    ...
    val optionValues: kotlin.collections.List<ProductModifierOptionValueFull>? = null
