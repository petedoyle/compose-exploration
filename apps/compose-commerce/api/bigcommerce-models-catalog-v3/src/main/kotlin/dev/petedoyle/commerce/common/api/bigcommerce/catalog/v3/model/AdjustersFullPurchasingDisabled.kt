 ...
 * 
 *
 * @param status Flag for whether the modifier value disables purchasing when selected on the storefront. This can be used for temporarily disabling a particular modifier value. 
 * @param message The message displayed on the storefront when the purchasing disabled status is `true`. 
 */
@JsonClass(generateAdapter = true)
data class AdjustersFullPurchasingDisabled (
