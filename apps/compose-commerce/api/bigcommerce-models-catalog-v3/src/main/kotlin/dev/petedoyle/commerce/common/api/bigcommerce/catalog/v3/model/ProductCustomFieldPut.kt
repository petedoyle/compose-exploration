 ...
 *
 * @param name The name of the field, shown on the storefront, orders, etc. Required for /POST 
 * @param `value` The name of the field, shown on the storefront, orders, etc. Required for /POST 
 * @param id The unique numeric ID of the custom field; increments sequentially. Required to update existing custom field in /PUT request. Read-Only
 */
@JsonClass(generateAdapter = true)
data class ProductCustomFieldPut (
