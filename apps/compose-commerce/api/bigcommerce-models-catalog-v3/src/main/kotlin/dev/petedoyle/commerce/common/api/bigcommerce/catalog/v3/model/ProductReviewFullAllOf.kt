 ...
 * 
 *
 * @param id The unique numeric ID of the product review; increments sequentially. 
 * @param productId The unique numeric identifier for the product with which the review is associated. 
 * @param dateCreated Date the product review was created. 
 * @param dateModified Date the product review was modified. 
 */
@JsonClass(generateAdapter = true)
data class ProductReviewFullAllOf (
