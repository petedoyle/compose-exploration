 ...
 *
 * @param url Category URL on the storefront. 
 * @param isCustomized Returns `true` if the URL has been changed from its default state (the auto-assigned URL that BigCommerce provides). 
 */
@JsonClass(generateAdapter = true)
data class CustomUrlCategory (
