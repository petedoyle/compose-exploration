...
data class ProductPost (
    ...
    val inventoryTracking: ProductPost.InventoryTracking? = null,
    ...
    val availability: ProductPost.Availability? = null,
    ...
    val giftWrappingOptionsType: ProductPost.GiftWrappingOptionsType? = null,
    ...
    @Json(name = "condition")
    val condition: ProductPost.Condition? = null,
    ...
    val openGraphType: ProductPost.OpenGraphType? = null,
    ...
    @Json(name = "variants")
    val variants: kotlin.collections.List<ProductVariantPostProduct>? = null
